...
then
    ...
    sudo yum update -y && sudo yum install -y sysstat
fi

LC_NUMERIC="en_US.UTF-8"
export LC_NUMERIC

URL="http://localhost:8080/instituicao/633de777228176c275235a90/aries/send-proof-request-filiacao"
...
BODY='{
    "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ3YWxsZXRfaWQiOiIxNDZhODhhYi1iNjI1LTRiMGItODM0NS0yODliZGVlYjFmMDUiLCJpYXQiOjE3MTc2ODg4OTcsImV4cCI6MTcxNzc3NTI5N30.beQOFWAqAEXgGHhdhYmFkLjDQs59wMmlPvRCYzpXkOE",
    "connection_id": "811cf474-6d5e-42a2-9d77-a16c407b1a97"
}'
